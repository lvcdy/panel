// Provider SVG Logos (inline SVG strings, brand color preferred)
...
export const LOGOS = {
  ...
  // Bunny CDN
  bunny:
    '<svg class="provider-logo" viewBox="0 0 24 24" fill="#FF8A00"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 4c.83 0 1.5.9 1.5 2s-.67 2-1.5 2-1.5-.9-1.5-2 .67-2 1.5-2zm4 0c.83 0 1.5.9 1.5 2s-.67 2-1.5 2-1.5-.9-1.5-2 .67-2 1.5-2zm-2 12c-2.76 0-5-1.79-5-4h10c0 2.21-2.24 4-5 4z"/></svg>',
  // Nginx
  nginx:
    '<svg class="provider-logo" viewBox="0 0 24 24" fill="#009639"><path d="M12 0L1.605 6v12L12 24l10.395-6V6L12 0zm6 16.59c0 .705-.646 1.29-1.529 1.29-.631 0-1.351-.255-1.801-.81l-6-7.141v6.66c0 .721-.57 1.29-1.274 1.29H7.32c-.721 0-1.29-.585-1.29-1.29V7.41c0-.705.63-1.29 1.5-1.29.646 0 1.38.255 1.83.81l5.97 7.141V7.41c0-.721.585-1.29 1.29-1.29h.075c.72 0 1.29.585 1.29 1.29v9.18z"/></svg>',
  // Apache
  apache:
    '<svg class="provider-logo" viewBox="0 0 24 24" fill="#D22128"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1.71 14.6L5.7 12l4.6-4.6 1.41 1.41L8.51 12l3.19 3.19-1.41 1.41zm5.42 0l-1.41-1.41L17.49 12l-3.19-3.19 1.41-1.41L20.3 12l-4.6 4.6z"/></svg>',
  // KeyCDN
  keycdn:
    '<svg class="provider-logo" viewBox="0 0 24 24" fill="#1F6BFF"><path d="M10.5 2a5.5 5.5 0 0 0-4.96 7.87L2 13.41V17h3.59l.83-.83-.83-.83L6.41 14.5l.83.83.83-.83-.83-.83L8.07 12.84l.83.83.83-.83-1.86-1.86A5.48 5.48 0 0 0 16 5.5 5.5 5.5 0 0 0 10.5 2zm2 3a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3z"/></svg>',
  // StackPath
  stackpath:
    '<svg class="provider-logo" viewBox="0 0 24 24" fill="#FBB03B"><path d="M2 4v4.8l10 5.7 10-5.7V4L12 9.7 2 4zm0 7.3V16l10 5.7V16L2 11.3zm20 0L12 16v5.7L22 16v-4.7z"/></svg>',
  // GitHub Pages
  github:
    '<svg class="provider-logo" viewBox="0 0 24 24" fill="currentColor"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg>',
  // Default
  globe:
    '<svg class="provider-logo" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',
} as const;
